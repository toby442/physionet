...
result_bb = summarize("String Kernel + BalancedBagging", bb_recalls, bb_precisions, bb_f1s, bb_aucs)
...
result_tm = summarize("String Kernel + Threshold Moving", tm_recalls, tm_precisions, tm_f1s, tm_aucs)
